...
from datasetscopy import make_dataloader2
from trainingcopy import config, features, truth, META_DIR
...
if validateMode:
    ...
    meta = pd.read_parquet('data/train_meta_656to660.parquet')
    ...
    BATCH_DIR = 'data/test' 
    META_DIR = '../work/test'
    meta = pd.read_parquet('data/test_meta.parquet')
